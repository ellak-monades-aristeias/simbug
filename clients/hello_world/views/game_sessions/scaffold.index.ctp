        ...
        <div class="panel-heading"><h3><span class="glyphicon glyphicon-list-alt"></span> <?php echo $pluralHumanName; ?>
                <div class="btn-group pull-right">
                    ...
                    <ul class="dropdown-menu" role="menu">
                        <li>   
                            <?php echo $this->Html->link(sprintf(__d('cake', '<span class="glyphicon glyphicon-plus-sign"></span> Create %s',true),$singularHumanName), array('action' => 'add'), array('escape' => false)); ?>
                        </li>
                        <?php
                        $done = array();
            ...
            <table class="table table-bordered table-hover table-condensed" >
                ...
                <tbody>
                    ...
                    foreach (${$pluralVar} as ${$singularVar}):
                        ...
                        echo $this->Html->link('<span class="glyphicon glyphicon-eye-open"><span>', array('action' => 'admin_status', ${$singularVar}[$modelClass][$primaryKey],), array('escape' => false, 'class' => 'btn btn-default btn-xs'));
        ...
        <div class="panel-footer">
            <p><?php
                    echo $this->Paginator->counter(array(
                        'format' => __d('cake', 'Page {:page} of {:pages}, showing {:current} records out of {:count} total, starting on record {:start}, ending on {:end}', true)
                    ));
                    ?></p>
